...
# Min and max depth of the tree during mutation
MIN_DEPTH_MUT = 0
MAX_DEPTH_MUT = 1
...
with open("Alzheimer_reduced.csv") as dataset:
    ...
    samples = list(list(float(elem) for elem in row) for row in dataset)
...
def print_tree(expr):
    """
    Print visually the given expression
    :param expr: expression to visualize
    :return:
    """
